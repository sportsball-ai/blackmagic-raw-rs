...
{
public:
    virtual HRESULT GetClipProcessingAttributeRange (/* in */ CFStringRef cameraType, /* in */ BlackmagicRawClipProcessingAttribute attribute, /* out */ Variant* valueMin, /* out */ Variant* valueMax) = 0;
    virtual HRESULT GetClipProcessingAttributeList (/* in */ CFStringRef cameraType, /* in */ BlackmagicRawClipProcessingAttribute attribute, /* out */ Variant* array /* optional */, /* out */ uint32_t* arrayElementCount /* optional */) = 0;
    virtual HRESULT GetFrameProcessingAttributeRange (/* in */ CFStringRef cameraType, /* in */ BlackmagicRawFrameProcessingAttribute attribute, /* out */ Variant* valueMin, /* out */ Variant* valueMax) = 0;
    virtual HRESULT GetFrameProcessingAttributeList (/* in */ CFStringRef cameraType, /* in */ BlackmagicRawFrameProcessingAttribute attribute, /* out */ Variant* array /* optional */, /* out */ uint32_t* arrayElementCount /* optional */) = 0;
    virtual HRESULT GetISOListForAnalogGain (/* in */ CFStringRef cameraType, /* in */ float analogGain, /* out */ uint16_t* array /* optional */, /* out */ uint32_t* arrayElementCount /* optional */) = 0;
